...
<body>
	...
	<section>
		<div class="topImg">
			<img class="pcTopImg" src="${pageContext.request.contextPath}/resources/images/menu03TopImg.png">
			<img class="mTopImg" src="${pageContext.request.contextPath}/resources/images/mMenu03TopImg.png">
		</div>
		<div class="contentWrap">
			<div class="sideMenuWrap">
				...
				<div class="navWrap">
					<ul class="navUl"> 
						...
						<li>
							<a href="#none">개인파산절차<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
							<ul class="sub_subDropdown">
								<li><a href="${pageContext.request.contextPath}/menu03_1">개인파산이란</a></li>
								<li><a href="${pageContext.request.contextPath}/menu03_3">개인파산서류</a></li>
							</ul>	
			...
			<div class="content">
				<img src="${pageContext.request.contextPath}/resources/images/menu03_2contentImg.png">
			</div>
		</div>
	</section>
	<footer>
